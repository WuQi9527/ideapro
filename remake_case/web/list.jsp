...
<head>
    ...
    <script>
        ...
        window.onload=function () {
            document.getElementById("delSelectUser").onclick=function () {
...
<div class="container">
    ...
    <form class="form-inline">
        ...
        <button type="submit" class="btn btn-default">查询</button> <div style="float: right"><tr>
        <td colspan="8" align="center"><a class="btn btn-primary" href="${pageContext.request.contextPath}/add.jsp">添加联系人</a></td>
        <td colspan="8" align="center"><a class="btn btn-primary" href="javascript:void(0);" id="delSelectUser">删除选中</a></td>
    </tr></div>
    </form>
    <form action="${pageContext.request.contextPath}/delSelectedUserServlet" id="form">
